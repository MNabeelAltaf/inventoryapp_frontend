...
const VendorBillReceipt = () => {
    return (
        <View style={styles.mainContainer}>
            <View style={styles.cont2}>
                <View style={styles.cont2a}>
                    <Text style={{ textAlign: 'center', marginTop: 15, color: '#6c6f78', fontSize: 13, }} >Vendor{'\n'}Bliss ERP</Text>
                    <Text style={{ textAlign: 'center', marginTop: 15, color: '#6c6f78', fontSize: 13, }}>Bill Reference{'\n'}S4545</Text>
                </View>
                <View style={styles.cont2a}>
                    <Text style={{ textAlign: 'center', marginTop: 15, color: '#6c6f78', fontSize: 13, }} >Bill date{'\n'}12/12/2023</Text>
...
export default VendorBillReceipt;