    ...
    return (
        <View style={styles.mainContainer}>
            ...
            <View style={styles.cont3}>
                <TouchableOpacity style={styles.btn} onPress={() => navigation.navigate("PurchaseOrderReceipt")} >
                    <Text style={{ color: 'white', fontSize: 15, textAlign: 'left', paddingLeft: 15, }} >P00012</Text>
